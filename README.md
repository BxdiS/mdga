...
Windows Discord client mod that takes the app back toward its 2018–2020 look by removing the shop, quests, the Nitro tab, avatar decorations, nameplates, profile effects, Nitro name styles, the emoji and stickers you can't send, Nitro promo popups and similar post-IPO additions. Every removal is its own module, and you choose which ones to install.
